...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""32704638-42db-4790-b876-8797accdba82"",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""467def29-f7e1-492c-a8d2-50f016edf0a9"",
                    ""path"": ""<OculusTouchController>/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
        ...
        {
            ""name"": ""HFS CustomActions"",
            ""id"": ""7d952159-abdc-4044-9cce-6cdc58c17804"",
            ""actions"": [
                {
                    ""name"": ""Rotate"",
                    ""type"": ""Value"",
                    ""id"": ""4dd3f9c7-3584-4d5b-b17b-6a9605efb256"",
                ...
                },
                {
                    ""name"": ""Screenshot"",
                    ""type"": ""Button"",
                    ""id"": ""37512a14-f768-4712-8bd6-81f0da76ff17"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""22be025c-777c-4ba1-b4f8-ff2a6bee08b5"",
    ...
    // HFS CustomActions
    private readonly InputActionMap m_HFSCustomActions;
    ...
    public struct HFSCustomActionsActions
    {
        ...
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(HFSCustomActionsActions set) { return set.Get(); }
        public void SetCallbacks(IHFSCustomActionsActions instance)
        {
            if (m_Wrapper.m_HFSCustomActionsActionsCallbackInterface != null)
            {
                @Rotate.started -= m_Wrapper.m_HFSCustomActionsActionsCallbackInterface.OnRotate;
                @Rotate.performed -= m_Wrapper.m_HFSCustomActionsActionsCallbackInterface.OnRotate;
                @Rotate.canceled -= m_Wrapper.m_HFSCustomActionsActionsCallbackInterface.OnRotate;
    ...
    public HFSCustomActionsActions @HFSCustomActions => new HFSCustomActionsActions(this);
    ...
    public interface IHFSCustomActionsActions
    {
